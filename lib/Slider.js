...
var ViewPropTypes = require("deprecated-react-native-prop-types");
var ImagePropTypes = require("deprecated-react-native-prop-types");
...
var DEFAULT_ANIMATION_CONFIGS = {
  ...
  Slider = function (_PureComponent) {
    _inherits(Slider, _PureComponent); function Slider() {
      var _ref; var _temp, _this, _ret; _classCallCheck(this, Slider); for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) { args[_key] = arguments[_key]; } return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Slider.__proto__ || Object.getPrototypeOf(Slider)).call.apply(_ref, [this].concat(args))), _this), _this.
                ...
                _measureContainer = function (x) {
                  ...
                  _measureTrack = function (x) {
                    ...
                    _measureThumb = function (x) {
                      ...
                      _handleMeasure = function (name, x) {
                        var _x$nativeEvent$layout =
                                  ...
                                  _setCurrentValueAnimated = function (value) {
                                    ...
                                    _fireChangeEvent = function (event) {
                                      ...
                                      _getTouchOverflowSize = function () {
                                        ...
                                        _getTouchOverflowStyle = function () {
                                          var _this$_getTouchOverfl =
